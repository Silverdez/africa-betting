...
class CasinosList extends Block
{
    public function __construct(Application $app)
    {
         ...
         * @var string
         */
        $this->name = __('Casinos List', 'sage');
         ...
         * @var string
         */
        $this->description = __('A simple Casinos List block.', 'sage');
    ...
    {
        $casinosList = new FieldsBuilder('casinos_list');
