  ...
  <div class="copyright bg-footerBgCopyright ">
    <div class="container mx-auto flex flex-col pt-4 pb-6 text-center px-6">
      <p class="text-0.7 lg:px-48 text-gray-400">
        africa-betting.com is a comparison site where you can compare all credit cards. Explore and take advantage of credit card bonus schemes, insurance, rewards programs, customer benefits and features. The free service will help you and thousands of other consumers find the best credit card for you.
      </p>
      <p class="text-0.7 text-gray-500">
        {{--        /* translators: 1: Theme name, 2: Theme author. */--}}
        @php(printf(esc_html__('Copyright © %1$s', 'africa-betting-theme'), ' africa-betting'))
