...
<section class="section section--hero hero relative">
  <div class="pt-16 lg:pt-20 pb-4 mb-4">
        ...
        <div class="flex flex-wrap">
          <div class="hero__heading w-full lg:w-4/6 lg:pr-16 mb-8 lg:mb-0">
            ...
            @if($fields['hero_link_url']['url'])
              <button class="block">
                <a class="inline-block bg-btnBg py-3 px-6 rounded-md mt-8 mb-6 text-white text-lg hover:bg-btnBgHover transition shadow-lg" href="{!! $fields['hero_link_url']['url'] !!}" target="{!! $fields['hero_link_url']['target'] !!}">
